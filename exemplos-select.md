...
`LIKE` é usado principalmente para realizar pesquisas em textos. Junto com o caractere `%` 
permite fazer buscas baseadas em partes de uma string.
...
Exemplo:do maior para o menor, ou de Z-A, de mais recente para mais antigo.
...
`HAVING` permite filtrar os grupos criados pelo `GROUPY BY`.
